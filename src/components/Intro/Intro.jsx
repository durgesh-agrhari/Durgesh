...
import boy from "../../img/durgesh2.png";
import glassesimoji from "../../img/glassesimoji.png";
import thumbup from "../../img/thumbup.png";
import crown from "../../img/crown.png";
import app from "../../img/appp.webp";
    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>Durgesh Agrhari</span>
          <span>
            FullStack Developer with high level of experience in web designing
            and app development, producting the Quality work.
          </span>
        </div>
      ...
      <div className="i-right">
        ...
        {/* <motion.div
          ...
          className="floating-div"
        >
          <FloatinDiv img={app} text1="App" text2="Developer" />
        </motion.div> */}
